...
test('Filter and display product descriptions', () => {
  ...
  const descriptions = map(filteredProducts, (product) => {
    ...
    const description = defaultToAny(product.description, 'No description provided.');
